...
public class open_workout6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.start_view6);

        timer = findViewById(R.id.timer);

        ring = MediaPlayer.create(open_workout6.this, R.raw.ring);
        ...
        String videopath = "android.resource://com.example.fitone/" + R.raw.barbellrow;

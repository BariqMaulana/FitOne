...
public class open_workout4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.start_view4);

        timer = findViewById(R.id.timer);

        ring = MediaPlayer.create(open_workout4.this, R.raw.ring);
        ...
        String videopath = "android.resource://com.example.fitone/" + R.raw.widegrippull;

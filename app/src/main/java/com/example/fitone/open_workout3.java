...
public class open_workout3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.start_view3);

        timer = findViewById(R.id.timer);

        ring = MediaPlayer.create(open_workout3.this, R.raw.ring);
        ...
        String videopath = "android.resource://com.example.fitone/" + R.raw.deadlift;

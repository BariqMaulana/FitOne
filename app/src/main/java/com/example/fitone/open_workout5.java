...
public class open_workout5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.start_view5);

        timer = findViewById(R.id.timer);

        ring = MediaPlayer.create(open_workout5.this, R.raw.ring);
        ...
        String videopath = "android.resource://com.example.fitone/" + R.raw.chinup;

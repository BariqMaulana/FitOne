...
public class open_workout2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.start_view2);

        timer = findViewById(R.id.timer);

        ring = MediaPlayer.create(open_workout2.this, R.raw.ring);
        ...
        String videopath = "android.resource://com.example.fitone/" + R.raw.cablerow;
